...
comparable_eircodes = ["D08XV0T", "D08FK52", "D08N2C4", "D08K2E0","D08V276"]
dwelling_types = ["101"]  # Apartment/Flat
ber_values = ["3","4","5","6","7","8","9","10","11"]
bedrooms = [1,2,3]
floor_range = range(30,70) # queries from low value to high, using the incremement below
floor_space_incr = 5
