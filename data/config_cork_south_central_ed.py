...
reference_eircode = "T12F5Y0"
# local_authority_value = "xx" # CORK CITY COUNTY COUNCIL
# electoral_area_value = "xxxxxxx" # CORK CITY SOUTH CENTRAL
reference_dwelling_type = "100"  # House
reference_ber = "16" # Exempt
...
comparable_eircodes = ["T12F5Y0", "T12F5W4", "T12X64V", "T12Y2AH","T12DTP2","T12K2F9","T12E9AC"]
dwelling_types = ["100","101"]  # House, Apartment/Flat
ber_values = ["3","5","6","7","9","11","16"] # A3,B2,B3,C1,C3,D2,Exempt
bedrooms = [1]
floor_range = range(30,50) # queries from low value to high, using the incremement below
floor_space_incr = 5
