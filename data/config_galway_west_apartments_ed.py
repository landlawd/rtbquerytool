...
reference_eircode = "H91N6K2"
# local_authority_value = "xx" # GALWAY CITY COUNTY COUNCIL
# electoral_area_value = "xxxxxxx" # GALWAY CITY WEST
...
comparable_eircodes = ["H91N6K2", "H91E6NW", "H91W9W7", "H91KCC1","H91FPF6"]
dwelling_types = ["101"]  # Apartment/Flat
ber_values = ["1","3","5","6","7","9","11"] # A1,A3,B2,B3,C1,C3,D2
bedrooms = [1,2,3]
floor_range = range(30,90) # queries from low value to high, using the incremement below
floor_space_incr = 5
