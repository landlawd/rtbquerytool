...
reference_eircode = "D04T3F4"
# local_authority_value = "xx" # DUBLIN CITY COUNTY COUNCIL
# electoral_area_value = "xxxxxxx" # PEMBROKE (parts of Ballsbridge, Sandymount, Ranelagh, Irishtown, Ringsend, Donnybrook)
reference_dwelling_type = "101"  # Apartment/Flat
reference_ber = "6" # B3
...
comparable_eircodes = ["D04T3F4", "D04K064", "D06Y750", "D04W184","D06EV61","D06XD26","D04YY05","D04N243","D06D7C8"]
dwelling_types = ["101"]  # Apartment/Flat
ber_values = ["1","3","5","6","7","9","11"]
bedrooms = [1,2,3]
floor_range = range(30,80) # queries from low value to high, using the incremement below
floor_space_incr = 5
