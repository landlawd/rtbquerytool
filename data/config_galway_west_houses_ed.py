...
ber_values = ["3","5","6","7","9","11","13","16"] # A3,B2,B3,C1,C3,D2,,E2,Exempt
bedrooms = [2,3,4,5]
floor_range = range(60,120) # queries from low value to high, using the incremement below
floor_space_incr = 5
